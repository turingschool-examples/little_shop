...
RSpec.describe "When a user adds an item to their cart" do
  it "displays a message" do
    ...
    expect(page).to_not have_content("#{item_1.merchant.name}")
    ...
    expect(page).to_not have_content("#{item_2.merchant.name}")
    ...
    expect(page).to_not have_content("$90.00")

    expect(page).to have_content("Your cart has been emptied.")
  end
end
