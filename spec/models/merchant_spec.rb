...
RSpec.describe Merchant do
  ...
  describe "methods" do
    before :each do
      ...
      @order_items_1 = OrderItem.create(order: @order_1, item: @ogre, quantity: 3, price: 20)
      @order_items_2 = OrderItem.create(order: @order_1, item: @giant, quantity: 1, price: 40)
      @order_items_3 = OrderItem.create(order: @order_2, item: @hippo, quantity: 9, price: 50)
    end
